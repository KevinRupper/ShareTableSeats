//
//  DestinationStationsDatasource.m
//  MesasAve
//
...
@interface DestinationStationsDatasource ()
{
...
@implementation DestinationStationsDatasource
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:@"didSelectDestinationStation" object:mSelectedStation];
}
           ...
           atIndex:(NSUInteger)sectionIndex forChangeType:(NSFetchedResultsChangeType)type
{
    switch(type)
    {
        case NSFetchedResultsChangeInsert:
            [self.destinationTableView insertSections:[NSIndexSet indexSetWithIndex:sectionIndex] withRowAnimation:UITableViewRowAnimationFade];
            break;
            
        case NSFetchedResultsChangeDelete:
            [self.destinationTableView deleteSections:[NSIndexSet indexSetWithIndex:sectionIndex] withRowAnimation:UITableViewRowAnimationFade];
            break;
...
{
    UITableView *tableView = self.destinationTableView;
